...
export const tabs: Record<string, TabData<any>> = {
  menu: {
    id: 'menu',
    modal: true,
    component: dynamic<ModalData>(() => import('@/widgets/Menu')),
    icon: Menu,
    section: 'top',
  },
  store: {
  ...
  friends: {
    id: 'friends',
    modal: true,
    component: dynamic<ModalData>(() => import('@/widgets/Friends')),
    icon: Users,
    section: 'bottom',
  },
  dailys: {
    id: 'dailys',
    modal: true,
    component: dynamic<ModalData>(() => import('@/widgets/DailyChallenges')),
    icon: BookMarked,
    section: 'bottom',
  },
} as const;
